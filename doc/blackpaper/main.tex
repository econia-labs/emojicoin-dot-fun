...
Numerical values are fully prescribed by the economic variables in table
...
\begin{table}[!htb]
  ...
  \end{tabular}
  \caption{Economic variables at time of state transition}
...
\subsection{Alternate economic variable selection}
