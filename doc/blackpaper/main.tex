...
\begin{table}[!htb]
  ...
  \begin{tabular}{|c|c|}
    ...
    $m_a$            & 45,000             \\ \hline
    $c_e = b_{r, c}$ & 350,000,000        \\ \hline
    $r_e$            & 100,000,000        \\ \hline
    $s_e$            & 450,000,000        \\ \hline
    ...
    $L_i$            & 1,000,000          \\ \hline
    $f_p$            & 25                 \\ \hline
    $b_{v, f}$       & 140,000,000        \\ \hline
    $q_{v, f}$       & 4,000              \\ \hline
    $b_{v, c}$       & 490,000,000        \\ \hline
    $q_{v, c}$       & 14,000             \\ \hline
  \end{tabular}
...
\begin{table}[!htb]
  ...
  \begin{tabular}{|c|c|}
    ...
    \texttt{EMOJICOIN\_REMAINDER}    & \texttt{10\_000\_000\_000\_000\_000} \\ \hline
    \texttt{EMOJICOIN\_SUPPLY}       & \texttt{45\_000\_000\_000\_000\_000} \\ \hline
    \texttt{LP\_TOKENS\_INITIAL}     & \texttt{100\_000\_000\_000\_000}     \\ \hline
    \texttt{BASE\_REAL\_FLOOR}       & \texttt{0}                           \\ \hline
    \texttt{QUOTE\_REAL\_FLOOR}      & \texttt{0}                           \\ \hline
    \texttt{BASE\_REAL\_CEILING}     & \texttt{35\_000\_000\_000\_000\_000} \\ \hline
    \texttt{QUOTE\_REAL\_CEILING}    & \texttt{1\_000\_000\_000\_000}       \\ \hline
    \texttt{BASE\_VIRTUAL\_FLOOR}    & \texttt{14\_000\_000\_000\_000\_000} \\ \hline
    \texttt{QUOTE\_VIRTUAL\_FLOOR}   & \texttt{400\_000\_000\_000}          \\ \hline
    \texttt{BASE\_VIRTUAL\_CEILING}  & \texttt{49\_000\_000\_000\_000\_000} \\ \hline
