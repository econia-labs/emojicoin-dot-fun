...
A pool fee rate $f_p$ denominated in basis points is assessed on the output of swap to
...
This set meets the restriction from equation \ref{eqn:bonding-curve-inequality}, derived
