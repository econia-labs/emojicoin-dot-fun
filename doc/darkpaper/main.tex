%cspell:words clamm, cpamm, keefer, zinsmeister
...
\begin{align} \label{eqn:bonding-curve-5}
  b_{v, f} & = \frac{m_s}{m_o} \cdot \frac{m_o^2}{m_s \cdot p_{crit} - m_o} \nonumber \\
  b_{v, f} & = \frac{m_s \cdot m_o}{m_s \cdot p_{crit} - m_o}
\end{align}

Hence the \gls*{clamm} is initialized with $q_{v, f}$ per (\ref{eqn:bonding-curve-4})
and $b_{v, c}$ per:
...
\begin{thebibliography}{2}
  \bibitem{pump} \url{https://www.pump.fun/board}, \url{https://x.com/pumpdotfun}.
  ...
  \bibitem{octas} \url{https://aptos.dev/reference/glossary/#gas-unit-price}. Retrieved
  April 11, 2024.
\end{thebibliography}
