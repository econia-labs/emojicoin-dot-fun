...
module rewards::emojicoin_dot_fun_qr_code {
    ...
    /// `signature_bytes` is generated by signing the claimant's address with the QR code private
    /// key, and can be verified by `public_key_bytes`, the corresponding QR code public key.
