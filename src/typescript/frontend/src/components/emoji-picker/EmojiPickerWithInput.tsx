...
export const EmojiPickerWithInput = ({
  ...
  const closeIconClassName = `flex items-center justify-center relative h-full ${mode !== "search" && "ml-[2.5ch] pr-[1ch]"} hover:cursor-pointer ${mode === "search" ? "med-pixel-close" : ""}`;
