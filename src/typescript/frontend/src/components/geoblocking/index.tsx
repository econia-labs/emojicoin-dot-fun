...
const Item: React.FC = () => {
  return (
    <div className="flex items-center justify-center min-w-[fit-content] gap-[16px]">
      <Text className="h-[2.4rem] whitespace-nowrap" lineHeight="2.4rem" textScale="display6" color="black" textAlign="center" fontWeight="600">
...
export const GeoblockedBanner: React.FC = () => {
  ...
  return <div className="w-full bg-pink">
